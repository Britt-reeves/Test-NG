...
@Test
    ...
    orderLink.click();
    //5. Select familyAlbum from product, set quantity to 5
//it is a drop down box so we will be using drop down box
   ...
   // quantity.clear();
    ...
    WebElement CaculateButton=driver.findElement(By.xpath("//input[@value='Calculate']"));

    CaculateButton.click();
    ...
    WebElement city=driver.findElement(By.id("cctl00_MainContent_fmwOrder_TextBox3"));
