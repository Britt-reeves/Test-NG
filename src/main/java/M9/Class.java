...
//Message instructer:there is a unique manager ID for each person that signs in I think
//so there isnt an element equal to mngr368294 the code I have is mngr392206
